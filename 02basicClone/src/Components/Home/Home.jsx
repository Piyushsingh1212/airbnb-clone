...
export default function Home() {
        ...
        <div className=' pt-5  flex justify-center align-center'>
            <div className='' >
                <ul className="list-none mx-20 pt-4 h-[111px] w-[770px] flex justify-center align-center rounded-[30px] border text-xl shadow-sm">
                    ...
                    Where
                    <h6 className='text-slate-500 text-[13px]'>Search Destinations</h6>
                </li>
                <li className='mx-[40px]'>Check-in
                    <h6 className='text-slate-500 text-[13px]'>Add Dates</h6>
                </li>
                <li className='mx-[40px]'>Check-out
                    <h6 className='text-slate-500 text-[13px] '>Add Dates</h6>
    ...
    <path d="M15.7955 15.8111L21 21M18 10.5C18 14.6421 14.6421 18 10.5 18C6.35786 18 3 14.6421 3 10.5C3 6.35786 6.35786 3 10.5 3C14.6421 3 18 6.35786 18 10.5Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className='pt-4'>
            <h2 className='text-2xl font-bold'>Popular homes in Gurgaon District</h2>
        </div>
        ...
        <div className='transition delay-150 duration-300 ease-linear hover:-translate-y-1 hover:scale-110 hover:bg-white..'>
            ...
            <h3 className='mx-5'>$30 for 2nights</h3>
            ...
            <h3 className='mx-5'>$20 for 2nights</h3>
